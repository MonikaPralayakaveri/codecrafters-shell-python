...
def main():
    ...
    while True: 
        try:
            ...
            # 3. SAVE HISTORY (ONLY HERE)
            # This ensures every command is saved EXACTLY ONCE
            ...
            try:
                ...
                if "|" in command:
                    try:
                        ...
                        print("Syntax error in pipe", file=sys.stderr)
                        continue 
                    ...
                    # Case 2: Mixed Pipe (Uses helper functions)
                    i = 0
                    prev_output = None
                    while i < len(parts):
                        args = parts[i]
